const PostgresHelper = require('../../../../../bin/helper/database/postgres')
const postgresConn = require('../../../../../bin/helper/database/postgres/connection')
const { database } = require('../../../../../bin/config')
...
describe('bin/helper/database/postgres/index.js', () => {
  ...
  describe('class Postgres', () => {
    ...
    before(() => {
      db = new PostgresHelper({ connectionString: database.postgres })
    })
    after(() => {
      db = null
    })
    ...
    beforeEach(() => {
      ...
      stubConnection = sinon.stub(postgresConn, 'getConnection')
